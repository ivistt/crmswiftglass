...
const WORKER_PERMISSION_DEFINITIONS = [
  ...
  { key: 'orders_comment_view', label: 'Видеть комментарий' },
  { key: 'orders_note_view', label: 'Видеть заметку' },
  ...
  { key: 'fill_missing_service_prices', label: 'Заполнять незаданные цены услуг' },
